...
public class ChangeCourseTitleCommandHandler : CommandHandler, IRequestHandler<ChangeCourseTitleCommand, ChangeCourseTitleResponse>
{
    private readonly IRepository<Domain.DomainObject.Course> _repository;
    private readonly IEventBus _eventBus;

    public ChangeCourseTitleCommandHandler(IRepository<Domain.DomainObject.Course> repository, IEventBus eventBus)
    {
